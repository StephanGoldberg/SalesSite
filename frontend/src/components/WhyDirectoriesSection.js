      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <blockquote className="twitter-tweet">
            ...
            <a href="https://twitter.com/KintuLabs/status/1760938279141269853?ref_src=twsrc%5Etfw">Directory Examples Tweet</a>
          </blockquote>
          ...
          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">let&apos;s say you have a directory website you monetise on listings 5 listings @ $29/month is $145 MRR 10 listings @ $49/month is $490 MRR 20 listings @ $99/month is $1980 MRR</p>
          ...
          <blockquote className="twitter-tweet">
            ...
            <a href="https://twitter.com/no_fear_inc/status/1885018805618819203?ref_src=twsrc%5Etfw">Portfolio Success Tweet</a>
          </blockquote>

          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">&quot;boring&quot; luxury hotel directory site. bootstrapped business. sold for $67 million in 2023.</p>
            <a href="https://twitter.com/staticmaker1/status/1874990726771249487?ref_src=twsrc%5Etfw">Hotel Directory Success Tweet</a>
          </blockquote>

          <blockquote className="twitter-tweet">
            <p lang="en" dir="ltr">One man working remotely. Bootstrapping. No ads. A simple meta directory of job boards. Passed $59K.</p>
            <a href="https://twitter.com/rrmdp/status/1885036318276596011?ref_src=twsrc%5Etfw">Job Board Success Tweet</a>
          </blockquote>
        </div>
