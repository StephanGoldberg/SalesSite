     ...
     <div className="relative max-w-7xl mx-auto px-6 sm:px-8 text-center">
       ...
       <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
         ...
         <a 
           ...
           className="bg-transparent border-2 border-white text-white py-3 px-8 rounded-full hover:bg-white/10 transition duration-300 flex items-center"
         >
           {"View Demo Site"}
           <span className="text-xs ml-2">{"(Admin credentials upon request)"}</span>
         </a>
       </div>
     </div>
   </section>
